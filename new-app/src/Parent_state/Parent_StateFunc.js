...
//
  ...
  return (
    <div>
      ...
      <button onClick={(event)=>{Filterdata(true);AgainFilterdata(false)}} style={{marginRight:"50px", backgroundColor:"red "}}>Filter-Data</button>
...
export default Parent_StateFunc;
